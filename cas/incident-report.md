...
**Appendix:** The Appendix section is for all supporting data: log files, graphs and charts, etc. In the case of incidents that directly impact certificates (i.e, not only precertificates), the Appendix MUST disclose details related to time-valid certificates affected by the incident.
