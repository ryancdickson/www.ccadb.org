...
| Roots for Production & Test Certificate Transparency Logs| [CSV](https://ccadb.my.salesforce-sites.com/ccadb/RootCACertificatesCombinedCTReportCSV) | Includes CAs that are trusted by at least one of the CCADB root stores or have applied to at least one of the CCADB root stores. [Description](https://docs.google.com/document/d/1qLdiln7eSbBy1x7w4NfG3DJ56_7Go94h33nkRf4b2PE/edit?usp=sharing) of report logic. |
