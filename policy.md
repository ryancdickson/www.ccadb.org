...
- subordinate CA ownership using the "Subordinate CA Owner" field. This is the subordinate CA Owner's name as it appears in the provided audit statements. CA Owners MUST leave this field blank if and only if both control of the private key and domain/IP/email validation activities are performed by the organization listed in the audit statement of the parent certificate.
